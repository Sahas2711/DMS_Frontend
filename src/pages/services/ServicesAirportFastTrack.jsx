...
const ServicesAirportFastTrack = () => {
    ...
    return (
        <div className="w-full">
            ...
            {/* Stats Section */}
            <section className="w-full bg-white py-8 md:py-12 px-5 sm:px-8 lg:px-12">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 md:gap-4 text-center">
                    ...
                    <Rise delay={0.1}>
                        <div className="flex flex-col items-center w-full md:w-1/4">
                            <span className="text-2xl md:text-3xl font-bold text-[var(--color-navy-light)] mb-1 md:mb-2">
                    ...
                    <Rise delay={0.2}>
                        <div className="flex flex-col items-center w-full md:w-1/4">
                            ...
                            <span className="text-xs md:text-sm text-[#7f8c9f]">flight monitoring</span>
                        </div>
                    </Rise>
                    ...
                    <Rise delay={0.3}>
                        <div className="flex flex-col items-center w-full md:w-1/4">
                            <span className="text-2xl md:text-3xl font-bold text-[var(--color-navy-light)] mb-1 md:mb-2 inline-flex items-center">
                ...
                <div className="page-container">
                    <div className="w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                        ...
                        <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
                            <Rise>
                                <span className="text-[var(--color-gold)] text-[10px] md:text-xs font-bold tracking-[0.15em] uppercase mb-4 block">
                                    Global Coverage
                                </span>
                            </Rise>

                            <Rise delay={0.1}>
                                <h2 className="text-[var(--color-ink)] text-2xl md:text-3xl lg:text-4xl font-semibold leading-tight mb-6">
                            ...
                            <Rise delay={0.2}>
                                <p className="text-[var(--color-text-muted)] text-sm leading-relaxed mb-10">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                                {[
                                    { region: 'Asia Pacific', cities: 'Singapore \u00b7 Bangkok \u00b7 Seoul' },
                                    { region: 'Middle East', cities: 'Dubai \u00b7 Doha \u00b7 Abu Dhabi' },
                                    { region: 'Europe', cities: 'London \u00b7 Paris \u00b7 Rome' },
                                    { region: 'Americas', cities: 'New York \u00b7 Miami \u00b7 Toronto' },
                                ].map((item, index) => (
                                    <Rise key={item.region} delay={0.1 * (index + 1)}>
                                        <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 flex flex-col justify-center">
                                            <h4 className="text-[var(--color-ink)] text-sm font-bold mb-1">{item.region}</h4>
                                            <p className="text-[var(--color-text-muted)] text-xs">{item.cities}</p>
                                        </div>
                                    </Rise>
                                ))}
                            </div>
            ...
            <section className="relative w-full py-20 sm:py-28 lg:py-36 flex items-center justify-center min-h-[500px] md:min-h-[600px]">
                {/* Background Image */}
                ...
                <div className="relative z-10 w-full max-w-7xl page-container flex flex-col lg:flex-row items-center justify-between gap-12">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
                        ...
                        <Rise>
                            <div className="flex items-center bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full mb-8 shadow-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-[var(--color-gold)] mr-2">
                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" />
                                </svg>
                                <span className="text-[var(--color-ink)] text-xs font-semibold">Meet, assist, and glide through arrivals</span>
                            </div>
                        </Rise>
                        ...
                        <Rise delay={0.3}>
                            <div className="flex flex-col sm:flex-row gap-6">
                                <div className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 text-[var(--color-gold)] mr-2">
                                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" />
                                    </svg>
                    ...
                    <Rise delay={0.2}>
                        <div className="w-full lg:w-[450px] bg-white rounded-xl shadow-2xl p-6 md:p-8 relative">
                            <div className="flex justify-between items-start mb-2">
                                <h3 className="text-[var(--color-ink)] text-xl md:text-2xl font-bold">Plan your fast track</h3>
                            </div>
                            <p className="text-[var(--color-text-muted)] text-xs mb-6">Get a confirmed itinerary within 2 hours.</p>

                            <form className="flex flex-col space-y-5">
                                {/* Service direction */}
                                <div className="flex flex-col">
                                    <label className="text-[var(--color-ink)] text-xs font-semibold mb-2" htmlFor="servicesairportfasttrack-serviceDirection">Service direction</label>
                                    <select id="servicesairportfasttrack-serviceDirection" name="serviceDirection" className="w-full border border-gray-300 rounded-md p-3 text-sm text-[var(--color-text-primary)] focus:ring-2 focus:ring-[var(--color-gold)] focus:outline-none bg-white">
                                ...
                                {/* Airport */}
                                <div className="flex flex-col">
                                    <label className="text-[var(--color-ink)] text-xs font-semibold mb-2" htmlFor="servicesairportfasttrack-airport">Airport</label>
                                    <select id="servicesairportfasttrack-airport" name="airport" className="w-full border border-gray-300 rounded-md p-3 text-sm text-[var(--color-text-primary)] focus:ring-2 focus:ring-[var(--color-gold)] focus:outline-none bg-white">
                                ...
                                <div className="flex gap-4">
                                    <div className="flex flex-col w-1/2">
                                        <label className="text-[var(--color-ink)] text-xs font-semibold mb-2" htmlFor="servicesairportfasttrack-arrivalDate">Arrival date</label>
                                        <input id="servicesairportfasttrack-arrivalDate" name="arrivalDate" type="text" placeholder="DD / MM / YYYY" className="w-full border border-gray-300 rounded-md p-3 text-sm text-[var(--color-text-primary)] focus:ring-2 focus:ring-[var(--color-gold)] focus:outline-none" />
                                    </div>
                                    <div className="flex flex-col w-1/2">
                                        <label className="text-[var(--color-ink)] text-xs font-semibold mb-2" htmlFor="servicesairportfasttrack-flightNumber">Flight number</label>
                                        <input id="servicesairportfasttrack-flightNumber" name="flightNumber" type="text" placeholder="e.g. EK 404" className="w-full border border-gray-300 rounded-md p-3 text-sm text-[var(--color-text-primary)] focus:ring-2 focus:ring-[var(--color-gold)] focus:outline-none" />
                                    </div>
                                </div>

                                {/* Submit */}
                                <button type="button" className="w-full bg-[var(--color-gold)] hover:bg-[var(--color-gold-light)] text-white font-bold py-3 rounded-md transition-colors flex justify-center items-center mt-2">
                                    Check availability
                            ...
                            <p className="text-[var(--color-text-muted)] text-[10px] text-center mt-6 leading-relaxed">
            ...
            <section className="w-full bg-[var(--color-cream)] py-20 sm:py-28 lg:py-36">
                <div className="page-container flex flex-col items-center">
                    ...
                    {/* Header */}
                    <Rise>
                        <h2 className="text-[var(--color-ink)] text-3xl md:text-4xl font-serif tracking-widest uppercase mb-4 text-center">
                            Arrive & Depart with Ease
                        </h2>
                    </Rise>
                    <Rise delay={0.1}>
                        <div className="w-16 md:w-24 h-[1px] bg-[var(--color-gold)] mb-12"></div>
                    </Rise>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
                        {[
                            ...
                            <Rise key={index} delay={0.1 * (index + 1)}>
                                <div className="bg-white rounded-lg overflow-hidden shadow-sm flex flex-col">
                                    {/* Image Placeholder */}
                                    <div className="w-full h-48 bg-[var(--color-stone)]"></div>
                                    {/* Content */}
                                    <div className="p-5 flex flex-col flex-grow justify-between">
                                        <h3 className="text-[var(--color-ink)] text-sm font-medium mb-3">{hotel.name}</h3>
            ...
            <section className="w-full bg-white py-20 sm:py-28 lg:py-36">
                <div className="page-container flex flex-col">
                    ...
                    <div className="mb-16 max-w-3xl text-left">
                        ...
                        <Rise delay={0.1}>
                            <h2 className="text-[var(--color-ink)] text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
                        {[
                            {
                                title: 'Meet at the moment you need',
                                description: 'Your host welcomes you at the aircraft bridge, curbside, or check-in\u2014exactly where your journey begins.',
                                icon: (
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                                ),
                            },
                            {
                                title: 'Priority through formalities',
                                description: 'Navigate immigration, security, and baggage collection with clear guidance and fast-track access where available.',
                                icon: (
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z" />
                                ),
                            },
                            {
                                title: 'Onward travel, coordinated',
                                description: 'We coordinate luggage support, terminal handovers, and your pre-arranged driver so nothing is left to chance.',
                                icon: (
                            ...
                            <Rise key={feature.title} delay={0.1 * (index + 1)}>
                                <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 flex flex-col items-start">
                                    <div className="bg-[#eff6ff] p-3 rounded-xl mb-6">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-[var(--color-gold)]">
                                            {feature.icon}
                                        </svg>
                                    </div>
                                    <h3 className="text-[var(--color-ink)] text-lg font-bold mb-4">{feature.title}</h3>
            ...
            <section className="w-full bg-[var(--color-cream)] py-20 sm:py-28 lg:py-36 overflow-hidden">
                <div className="page-container flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12 lg:gap-20">

                    {/* Left Column */}
                    <div className="w-full lg:w-1/3 flex flex-col items-start text-left mt-2">
                        <Rise>
                            <span className="text-[var(--color-ink)] text-[10px] md:text-xs font-bold tracking-[0.15em] uppercase mb-4 block">
                                Simple by Design
                            </span>
                        </Rise>

                        <Rise delay={0.1}>
                            <h2 className="text-[var(--color-ink)] text-3xl md:text-4xl font-bold leading-tight mb-6 text-[var(--color-navy-light)]">
                                Three steps to a calmer <br className="hidden xl:block" /> journey.
                            </h2>
                        </Rise>

                        <Rise delay={0.2}>
                            <p className="text-[var(--color-text-muted)] text-sm leading-relaxed mb-10 max-w-sm">
            ...
            <section className="relative w-full bg-[var(--color-navy)] py-20 sm:py-28 lg:py-36 flex items-center justify-center overflow-hidden min-h-[350px]">
                <div className="relative z-10 w-full max-w-7xl page-container flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            {/* FAQ Section */}
            <section className="w-full bg-white py-20 sm:py-28 lg:py-36">
                <div className="page-container max-w-4xl flex flex-col space-y-4">
                    {faqItems.map((faq, index) => (
                        <Rise key={index} delay={0.1 * (index + 1)}>
                            <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                                ...
                                >
                                    <span className="text-[var(--color-ink)] text-sm md:text-[15px] font-medium">{faq.question}</span>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        strokeWidth={2}
                                        stroke="currentColor"
                                        className={`w-4 h-4 text-[var(--color-text-muted)] transition-transform duration-300 ${openFaq === index ? 'rotate-180' : ''}`}
                                    >
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                    </svg>
                                </button>
                                <div className={`px-6 text-[var(--color-text-muted)] text-sm leading-relaxed bg-white overflow-hidden transition-all duration-300 ease-in-out ${openFaq === index ? 'max-h-40 pb-5 border-t border-gray-100 mt-2 pt-4 opacity-100' : 'max-h-0 opacity-0'}`}>
                                    {faq.answer}
                                </div>
                            </div>
                        </Rise>
                ...
                <div className="page-container flex flex-col items-center text-center">
                    ...
                    <Rise delay={0.2}>
                        <p className="text-gray-300 text-sm md:text-base leading-relaxed mb-10 max-w-lg">
                            Let us handle the airport formalities while you focus on what matters.
                        </p>
                    </Rise>
                    <Rise delay={0.3}>
                        <Link
