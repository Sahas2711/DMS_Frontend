...
const CheckIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-gold flex-shrink-0 mt-0.5">
...
const Services = () => {
    return (
        <div className="w-full bg-[#FFFFFF]">
            <Seo {...PAGE_META['/services']} path="/services" />

            <PageHero image={servicesHeroImg} alt="" eyebrow="Services" uppercase />

            {/* Intro Section */}
            <section className="w-full bg-ivory py-20 md:py-24 px-6 md:px-12 lg:px-20 xl:px-32 flex justify-center border-b border-gray-200/50">
                <motion.div 
                ...
                >
                    ...
                    <h2 className="text-navy text-3xl md:text-4xl lg:text-5xl font-serif font-bold mb-6">
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="w-full lg:w-1/2 aspect-[16/11] rounded-2xl overflow-hidden shadow-md relative group">
                                    ...
                                    <div className="absolute bottom-4 right-4 bg-white/95 backdrop-blur-sm text-navy text-xs font-bold px-3 py-1.5 rounded-lg shadow-sm">
                                        {service.priceHint}
                                    </div>
                                </div>
                                ...
                                <div className="w-full lg:w-1/2 flex flex-col text-left">
                                    <h3 className="text-navy text-2xl sm:text-3xl font-serif font-bold mb-3 leading-snug">
                                        {service.title}
                                    </h3>
                                    <p className="text-gold text-xs sm:text-sm font-medium mb-4 italic">
                                        "{service.tagline}"
                                    </p>
                                    ...
                                    <div className="flex flex-wrap items-center gap-3.5 pt-4 border-t border-gray-200">
                                        <Link
                                            to={service.href}
                                            className="bg-navy hover:bg-[#152a52] text-white text-xs font-bold px-6 py-3.5 rounded-xl transition-all shadow-sm uppercase tracking-wider text-center flex items-center gap-2 cursor-pointer"
                                        >
                                            Explore Details &rarr;
                                        </Link>
                                        <Link
                                            to="/booking"
                                            className="bg-gold hover:bg-[#b59758] text-navy text-xs font-bold px-6 py-3.5 rounded-xl transition-all shadow-sm uppercase tracking-wider text-center cursor-pointer"
                                        >
                                            Book Service
                                        </Link>
                                    </div>
            ...
            <section className="w-full bg-navy text-white py-20 md:py-28 px-6 md:px-12 lg:px-20 xl:px-32 flex justify-center">
                <div className="w-full max-w-7xl">
                    ...
                    >
                        <span className="text-[11px] font-bold tracking-[0.25em] text-gold uppercase mb-2 block">
                        ...
                        <motion.div 
                            ...
                            className="w-20 h-[1px] bg-gold mx-auto mb-6 opacity-80"
                        />
            ...
            <section className="w-full bg-[#F8F6F0] py-20 md:py-24 px-6 md:px-12 lg:px-20 xl:px-32 flex justify-center">
                ...
                >
                    <div className="absolute -right-16 -bottom-16 w-64 h-64 rounded-full bg-gold/10 blur-3xl pointer-events-none"></div>
                    <div className="absolute -left-16 -top-16 w-64 h-64 rounded-full bg-gold/10 blur-3xl pointer-events-none"></div>

                    <span className="text-[11px] font-bold tracking-[0.2em] text-gold uppercase mb-3 block">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center">
                        <Link
                            to="/booking"
                            className="w-full sm:w-auto bg-gold hover:bg-[#b59758] text-navy text-xs font-bold px-8 py-4 rounded-xl transition-all shadow-md uppercase tracking-wider cursor-pointer text-center"
                        >
                            Book Online Now
                        </Link>
                        <Link
