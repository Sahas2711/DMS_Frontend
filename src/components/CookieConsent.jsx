        ...
        <AnimatePresence>
            {consent === null && (
                <motion.div
                    ...
                    className="fixed bottom-4 left-4 right-4 md:left-auto md:right-6 md:bottom-6 md:max-w-xl z-[90] bg-navy text-gray-200 rounded-2xl shadow-2xl border border-white/10 p-5 md:p-6"
                >
